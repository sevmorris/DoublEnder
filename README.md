...
<p align="center">
  ...
  <br />
  <strong>Version:</strong> 1.6.21le
  <br />
  <a href="https://github.com/sevmorris/DoublEnder/releases/latest/download/DoublEnder-v1.6.21le.dmg"><strong>Download Latest (DMG)</strong></a>
  ·
