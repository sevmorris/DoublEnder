...
<p align="center">
  ...
  <br />
  <strong>Version:</strong> 1.7.1lr
  <br />
  <a href="https://github.com/sevmorris/DoublEnder/releases/latest/download/DoublEnder-v1.7.1lr.dmg"><strong>Download Latest (DMG)</strong></a>
  ·
