...
<p align="center">
  ...
  <br />
  <strong>Version:</strong> 1.6.19le
  <br />
  <a href="https://github.com/sevmorris/DoublEnder/releases/latest/download/DoublEnder-v1.6.19le.dmg"><strong>Download Latest (DMG)</strong></a>
  ·
